...
def main():
    ...
    output_file = PROJECT_ROOT / "answers_bge_bm25_final_off.txt"
    ...
    from gemma_rag.gemma_generator import OLLAMA_GEMMA_MODEL
    print(f"Loaded {len(questions)} questions. Using {OLLAMA_GEMMA_MODEL} for generation.")
    ...
    with open(output_file, "w", encoding="utf-8") as out:
        for i, q in enumerate(questions, 1):
            ...
            try:
                ...
                # Generate answer using the Gemma model
